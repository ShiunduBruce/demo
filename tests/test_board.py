...
class TestBoard:
    """
        Every test here is based on the board.field coordinates, 
        where we check if some initial moves are possible to be made
    """

# ROOK TESTS
    # Check horizontally from left to right
    def test_rook_left_to_right(self):
        figures = [Rook("white"), Bishop("white"),
                    Knight("white"), Pawn("white"), Rook("blue"), 
                    Bishop("blue"), Knight("blue"), Pawn("blue")]
        ...
        for x in [1, 2, 3, 4]:
            for y in [1, 2, 3]:
                assert board.field[curr_pos][0].check_move_possible(
                    (curr_pos, 0), (x, y), board) == True
    ...
    def test_rook_right_to_left(self):
        figures = [Rook("white"), Bishop("white"), 
                    ...
                    Rook("blue"), Bishop("blue"), 
                    Knight("blue"), Pawn("blue")]
        ...
        for x in [1, 2, 3, 4]:
            for y in [0, 1, 2]:
                assert board.field[curr_pos][3].check_move_possible(
                    (curr_pos, 3), (x, y), board) == True
    ...
    def test_rook_top_to_bottom(self):
        figures = [Rook("white"), Bishop("white"), Knight("white"), 
                    Pawn("white"), Rook("blue"), Bishop("blue"), 
                    Knight("blue"), Pawn("blue")]
        ...
        for y in [0, 1, 2, 3]:
            for x in [2, 3, 4]:
                assert board.field[1][curr_pos].check_move_possible(
                    (1, curr_pos), (x, y), board) == True
    ...
    def test_rook_bottom_to_top(self):
        ...
        for y in [0, 1, 2, 3]:
            for x in [1, 2, 3]:
                assert board.field[4][curr_pos].check_move_possible(
                    (4, curr_pos), (x, y), board) == True
...
# BISHOP TESTS
    ...
    def test_bishop_main_diagonals(self):
        ...
        for x, y in moves:
            assert board.field[1][0].check_move_possible(
                (1, 0), (x, y), board) == True
        ...
        for x, y in moves:
            assert board.field[4][0].check_move_possible(
                (4, 0), (x, y), board) == True
...
# KNIGHT TESTS
    ...
    def test_knight_l_moves(self):
        ...
        for x, y in moves:
            assert board.field[2][1].check_move_possible(
                (2, 1), (x, y), board) == True
